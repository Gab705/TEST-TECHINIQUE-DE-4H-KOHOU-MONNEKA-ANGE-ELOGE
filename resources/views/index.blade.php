...
<form method="POST" action="{{ route('register') }}">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="name" value="" id="name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
    </div>
    <div class="mb-4">
    ...
    <h2 class="flex items-center justify-center mb-3">
        ...
        <p><a href="{{ route('ShowLogin') }}" class="ml-2 underline underline-offset-1">Connexion</a></p>
    </h2>
